...
export class StaffService {
    ...
    static async registerStaff(body, img, dataToken) {
        try {
            ...
            const link = `http://localhost:3000/v1/api/staff/verify?id=${staff._id}`
    ...
    static async RegisterVerify (query) {
        const { id } = query
    ...
    static async loginStaff(body, dataToken) {
        try {
